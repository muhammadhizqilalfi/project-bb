...
class DropdownSettingController extends Controller
{
    ...
    {
        $optionsData = DropdownOption::orderBy('category')
            ->orderBy('label')
            ->get()
            ->map(fn ($item) => [
                'id' => $item->id,
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Opsi dropdown berhasil ditambahkan');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->back()->with('success', 'Opsi dropdown berhasil diperbarui');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('success', 'Opsi dropdown berhasil dihapus');
    }
}