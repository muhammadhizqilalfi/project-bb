          ...
          <div class="lg:col-span-6 space-y-6">
            <div class="bg-white rounded-xl shadow-xs border border-slate-200/80 p-6 space-y-5">
              <div class="flex items-center gap-3 pb-3 border-b border-slate-100">
                ...
                <h2 class="text-xs font-bold text-slate-900 uppercase tracking-wider">URAIAN BARANG BUKTI & PENYIMPANAN</h2>
              </div>
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input v-model="formCase.jenisBarangBukti" type="text" required placeholder="e.g. Narkotika / Kendaraan" class="w-full bg-[#F4F6F8] border border-transparent rounded-lg px-3.5 py-2.5 text-xs text-slate-800 outline-none focus:bg-white focus:border-slate-300 focus:ring-2 focus:ring-[#FFD000] transition-all" />
                </div>
                <div>
                  ...
                  <input v-model="formCase.tempatPenyimpanan" type="text" required placeholder="Gudang BB Locker A2" class="w-full bg-[#F4F6F8] border border-transparent rounded-lg px-3.5 py-2.5 text-xs text-slate-800 outline-none focus:bg-white focus:border-slate-300 focus:ring-2 focus:ring-[#FFD000] transition-all" />
                </div>
              </div>
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input v-model="formCase.jumlah" type="number" required placeholder="0" class="w-full bg-[#F4F6F8] border border-transparent rounded-lg px-3.5 py-2.5 text-xs text-slate-800 outline-none focus:bg-white focus:border-slate-300 focus:ring-2 focus:ring-[#FFD000] transition-all" />
                </div>
                <div>
                  ...
                  <input v-model="formCase.satuan" type="text" required placeholder="Gram / Unit / Paket" class="w-full bg-[#F4F6F8] border border-transparent rounded-lg px-3.5 py-2.5 text-xs text-slate-800 outline-none focus:bg-white focus:border-slate-300 focus:ring-2 focus:ring-[#FFD000] transition-all" />
                </div>
              </div>
              <div>
                ...
                <textarea v-model="formCase.ukuranDetail" rows="2" required placeholder="Contoh: Plastik klip transparan berisi kristal putih..." class="w-full bg-[#F4F6F8] border border-transparent rounded-lg p-3 text-xs text-slate-800 outline-none focus:bg-white focus:border-slate-300 focus:ring-2 focus:ring-[#FFD000] transition-all resize-none"></textarea>
              </div>
            </div>

            <div class="bg-white rounded-xl shadow-xs border border-slate-200/80 p-6 space-y-5">
              <div class="flex items-center gap-3 pb-3 border-b border-slate-100">
                <div class="p-2 bg-slate-100 text-slate-800 rounded-lg"><CheckSquare class="w-5 h-5" /></div>
                <h2 class="text-xs font-bold text-slate-900 uppercase tracking-wider">STATUS & PUTUSAN</h2>
              </div>
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label class="block text-[11px] font-bold text-slate-600 uppercase tracking-wider mb-1.5">DISELESAIKAN</label>
                  <select v-model="formCase.statusDiselesaikan" class="w-full bg-[#F4F6F8] border border-transparent rounded-lg px-3.5 py-2.5 text-xs text-slate-800 outline-none focus:bg-white focus:border-slate-300 focus:ring-2 focus:ring-[#FFD000] transition-all">
                ...
                <div>
                  <label class="block text-[11px] font-bold text-slate-600 uppercase tracking-wider mb-1.5">TGL PUTUSAN & IJIN JAKSA AGUNG</label>
              ...
              <div>
                <label class="block text-[11px] font-bold text-slate-600 uppercase tracking-wider mb-1.5">KETERANGAN</label>
                <textarea v-model="formCase.keterangan" rows="2" placeholder="Catatan proses, nomor putusan pengadilan..." class="w-full bg-[#F4F6F8] border border-transparent rounded-lg p-3 text-xs text-slate-800 outline-none focus:bg-white focus:border-slate-300 focus:ring-2 focus:ring-[#FFD000] transition-all resize-none"></textarea>
              </div>
            </div>
          </div>
        </div>
            ...
            <table class="w-full text-left border-collapse">
              <thead class="bg-slate-800 text-white text-[10px] uppercase tracking-wider">
                <tr>
                  ...
                  <th class="p-3 border border-slate-700">Barang Bukti & Spesifikasi</th>
                  <th class="p-3 border border-slate-700">Penyimpanan & Tgl Putusan</th>
              ...
              <tbody class="text-xs bg-white text-slate-700">
                <tr>
                  ...
                  <td class="p-3 border border-slate-300 align-top">
                    ...
                    <div class="mt-1 text-slate-600 line-clamp-2" :title="formCase.ukuranDetail">{{ formCase.ukuranDetail || '-' }}</div>
                    <div class="mt-2 font-bold text-blue-700">Total: {{ formCase.jumlah || '0' }} {{ formCase.satuan || '' }}</div>
                  </td>
                  <td class="p-3 border border-slate-300 align-top">
                    <div><span class="font-semibold text-slate-900">Lokasi:</span> {{ formCase.tempatPenyimpanan || '-' }}</div>
                    <div class="mt-1"><span class="font-semibold text-slate-900">Tgl KEP:</span> {{ formCase.tglPelaksanaanPutusan || '-' }}</div>
                  </td>
