...
const form = ref({
  satuanKerja: '',
  kategoriTindakPidana: '', // Mandatory Field Baru
  noRegBendaSitaan: '',
  noRegPenyidikan: '',
  identitasTersangka: '',
  pasalDisangkakan: '',
...
// Options Kategori Tindak Pidana LapBul 3A
...
const submitForm = () => {
  console.log('Data Form 3A disubmit:', form.value);
  // Tambahkan logika submit / router.post di sini
};
</script>
    ...
    <div class="p-8 space-y-6 max-w-7xl mx-auto">
      ...
      <form @submit.prevent="submitForm" class="space-y-6">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <!-- LEFT COLUMN: IDENTITAS PERKARA & SATKER (6 Columns) -->
          <div class="lg:col-span-6 bg-white rounded-xl shadow-xs border border-slate-200/80 p-6 space-y-5">
            ...
            <!-- Kategori Tindak Pidana (FIELD BARU) -->
            <div>
            ...
            <div>
              ...
              <textarea
                v-model="form.identitasTersangka"
                rows="3"
                required
          ...
          <!-- RIGHT COLUMN: URAIAN BARANG BUKTI & STATUS (6 Columns) -->
          <div class="lg:col-span-6 space-y-6">
            
            <!-- CARD 2: URAIAN BARANG BUKTI & PENYIMPANAN -->
            <div class="bg-white rounded-xl shadow-xs border border-slate-200/80 p-6 space-y-5">
              <div class="flex items-center justify-between pb-3 border-b border-slate-100">
                ...
                <span class="text-[10px] font-mono bg-slate-100 text-slate-600 px-2 py-1 rounded font-bold">
                  ID: BB-2023-9912
                </span>
              </div>
            ...
            <div class="bg-white rounded-xl shadow-xs border border-slate-200/80 p-6 space-y-5">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    v-model="form.statusDiselesaikan"
                    class="w-full bg-[#F4F6F8] border border-transparent rounded-lg px-3.5 py-2.5 text-xs text-slate-800 outline-none focus:bg-white focus:border-slate-300 focus:ring-2 focus:ring-[#FFD000] transition-all"
                  >
                ...
                <!-- Tgl Pelaksanaan Putusan Hakim & Ijin Jaksa Agung -->
                <div>
                  <label class="block text-[11px] font-bold text-slate-600 uppercase tracking-wider mb-1.5">
